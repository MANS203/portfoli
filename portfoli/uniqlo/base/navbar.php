...
?>
 ...
 <a href="uniqlo.php?logout=<?php echo $user_id; ?>" onclick="return confirm('Are you sure?');" class="btn btn-danger float-right">Logout</a>
 </div>
</nav>

        <div class="container">
        
            <a href="uniqlo.php" class="logo">
            ...
            <nav>
                <ul>
                    <li><a href="uniqlo.php">Home</a></li>  
            ...
            <!-- create a search button -->
                <a href="uniqlo.php"><i class="fa-sharp fa-solid fa-magnifying-glass"></i></a>
