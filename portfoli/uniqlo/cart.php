...
<?php include('base/navbar.php');?>
  ...
  <div class="Landing-cart">
            <h2>Cart</h2>
            <a href="uniqlo.php">Home</a><span class='cart'>/cart</span>
 </div>
...
<tr>
    ...
    <td>
        <button class="remove"><a href="uniqlo.php?remove=<?php echo $fetch_cart['id']; ?>" class="delete-btn" onclick="return confirm('Do yo want to delete this product from cart');">delete</a></i></button>
...
<tr class="table-bottom">
         ...
         <td><a href="uniqlo.php?delete_all" onclick="return confirm('Delete all products from card ?');" class="delete-btn <?php echo ($grand_total > 1)?'':'disabled'; ?>">Delete All</a></td>
      </tr>
</tbody>
